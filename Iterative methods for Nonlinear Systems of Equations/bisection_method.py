...
if __name__ == '__main__':
    ...
    result_Ait = iterative_method(f, 0)
    print(bcolors.OKBLUE, f"\nThe equation f(x) has approximate result at {result_Ait}", bcolors.ENDC)
